...
GC_1 = Coupling(name = 'GC_1',
                value = 'CbbPhi*complex(0,1)',
                order = {'NP':1})

GC_2 = Coupling(name = 'GC_2',
                value = 'CHL*complex(0,1)',
                order = {'NP':1})

GC_3 = Coupling(name = 'GC_3',
                value = 'CHR*complex(0,1)',
                order = {'NP':1})

GC_4 = Coupling(name = 'GC_4',
                value = 'CPhiL*complex(0,1)',
                order = {'NP':1})

GC_5 = Coupling(name = 'GC_5',
                value = 'CPhiR*complex(0,1)',
                order = {'NP':1})

GC_6 = Coupling(name = 'GC_6',
                value = 'CWL*complex(0,1)',
                order = {'NP':1})
...
GC_22 = Coupling(name = 'GC_22',
                 value = '(CZL*ee*complex(0,1))/(2.*cw*sw)',
                 order = {'NP':1,'QED':1})

GC_23 = Coupling(name = 'GC_23',
                 value = '(CZR*ee*complex(0,1))/(2.*cw*sw)',
                 order = {'NP':1,'QED':1})
