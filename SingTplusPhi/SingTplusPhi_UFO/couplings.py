...
GC_49 = Coupling(name = 'GC_49',
                 value = 'complex(0,1)*kappaW',
                 order = {'QNP1':1})

GC_50 = Coupling(name = 'GC_50',
                 value = 'complex(0,1)*kappaZ',
                 order = {'QNP1':1})
...
GC_54 = Coupling(name = 'GC_54',
                 value = 'complex(0,1)*kappaH*MT',
                 order = {'QNP1':1})

GC_55 = Coupling(name = 'GC_55',
                 value = 'complex(0,1)*kappaH*MTP',
                 order = {'QNP1':1})
...
GC_89 = Coupling(name = 'GC_89',
                 value = '(4*complex(0,1)*G**2*kge)/vev',
                 order = {'QCD':2,'QED':1,'QNP3':1})

GC_90 = Coupling(name = 'GC_90',
                 value = '(4*G**3*kge)/vev',
                 order = {'QCD':3,'QED':1,'QNP3':1})

GC_91 = Coupling(name = 'GC_91',
                 value = '(-4*complex(0,1)*G**4*kge)/vev',
                 order = {'QCD':4,'QED':1,'QNP3':1})
...
GC_150 = Coupling(name = 'GC_150',
                  value = 'complex(0,1)*ktpe*cmath.cos(tl)',
                  order = {'QNP2':1})
