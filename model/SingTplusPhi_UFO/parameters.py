...
m1 = Parameter(name = 'm1',
               ...
               value = 100.,
               texname = '\\text{m1}',
               lhablock = 'BSMExternal',
               lhacode = [ 1 ])

ktpe = Parameter(name = 'ktpe',
                 nature = 'external',
                 type = 'real',
                 value = 1.,
                 texname = '\\text{ktpe}',
...
tl = Parameter(name = 'tl',
               nature = 'internal',
               type = 'real',
               value = '0.5*cmath.asin((2*m1*MTP)/cmath.sqrt(-4*MT**2*MTP**2 + (m1**2 + MT**2 + MTP**2)**2))',
               texname = '\\text{tl}')
...
kappaH = Parameter(name = 'kappaH',
                   nature = 'internal',
                   type = 'real',
                   value = '(0.07836275001238224*cmath.sin(2*tl))/(MW*sw)',
                   texname = '\\text{kappaH}')

kappaW = Parameter(name = 'kappaW',
                   nature = 'internal',
                   type = 'real',
                   value = '(0.22164332770472675*cmath.sin(tl))/sw',
                   texname = '\\text{kappaW}')

kappaZ = Parameter(name = 'kappaZ',
                   nature = 'internal',
                   type = 'real',
                   value = '(0.07836275001238224*cmath.sin(2*tl))/(cw*sw)',
                   texname = '\\text{kappaZ}')
